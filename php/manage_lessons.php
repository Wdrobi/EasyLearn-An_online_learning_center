...
<body>
    ...
    <div class="container" style="margin-top: 90px;">
        <div class="dashboard card" style="padding: 2.5rem 2rem 2rem 2rem; margin-top: 2rem;">
            <h1 style="margin-bottom: 1.5rem;">Manage Lessons for <?php echo htmlspecialchars($course['title']); ?></h1>
            <a href="add_lesson.php?course_id=<?php echo $course_id; ?>" class="btn btn-primary" style="margin-bottom: 1.5rem;">Add Lesson</a>
            <div class="card" style="padding: 0;">
                <table class="table">
                    <thead><tr><th>Order</th>
                    <th>Title</th>
                    <th>Actions</th></tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_lesson.php?id=<?php echo $lesson['id']; ?>&course_id=<?php echo $course_id; ?>" class="btn btn-secondary">Edit</a>
                                <a href="delete_lesson.php?id=<?php echo $lesson['id']; ?>&course_id=<?php echo $course_id; ?>" class="btn btn-danger" onclick="return confirm('Delete this lesson?');">Delete</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
